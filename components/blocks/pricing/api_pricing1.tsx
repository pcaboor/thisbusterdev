    ...
    <div className="w-full py-10 ">
        <div className="container mx-auto">
            <div className="flex text-center justify-center items-center gap-4 flex-col">
                ...
                <div className="grid text-left w-full grid-cols-3 lg:grid-cols-4 divide-x pt-10">
                    <div className="col-span-3 lg:col-span-1"></div>
                    <div className="px-3 py-1 md:px-6 md:py-4  gap-2 flex flex-col">
                        <p className="text-l font-bold">Startup</p>
                    ...
                    <div className="px-3 py-1 md:px-6 md:py-4 gap-2 flex flex-col">
                        <p className="text-l font-bold">Growth</p>
                        <p className="text-sm text-muted-foreground">
                            Our goal is to streamline SMB trade, making it easier and faster
                            than ever for everyone and everywhere.
                        </p>
                    ...
                    <div className="px-3 py-1 md:px-6 md:py-4 gap-2 flex flex-col">
                        <p className="text-l font-bold">Enterprise</p>
                        <p className="text-sm text-muted-foreground">
                            Our goal is to streamline SMB trade, making it easier and faster
                            than ever for everyone and everywhere.
                        </p>
                    ...
                    <div className="px-3 py-1 md:px-6 md:py-4 flex justify-center text-sm">
